...
train_clip_text=np.load("~/multimodel_rumor_detection/clip_feature/train_text_clip_feature.npy")
train_clip_image=np.load("~/multimodel_rumor_detection/clip_feature/train_image_clip_feature.npy")
train_vgg_image=np.load("~/multimodel_rumor_detection/normal_feature/train_image_VGG_feature.npy")
train_bert_text=np.load("~/multimodel_rumor_detection/normal_feature/train_text_Bert_feature.npy")
train_reason_text=np.load("~/multimodel_rumor_detection/reason_feature/train_text_reason_feature.npy")
train_reason_image=np.load("~/multimodel_rumor_detection/reason_feature/train_image_reason_feature.npy")

test_clip_text=np.load("~/multimodel_rumor_detection/clip_feature/test_text_clip_feature.npy")
test_clip_image=np.load("~/multimodel_rumor_detection/clip_feature/test_image_clip_feature.npy")
test_vgg_image=np.load("~/multimodel_rumor_detection/normal_feature/test_image_VGG_feature.npy")
test_bert_text=np.load("~/multimodel_rumor_detection/normal_feature/test_text_Bert_feature.npy")
test_reason_text=np.load("~/multimodel_rumor_detection/reason_feature/test_text_reason_feature.npy")
test_reason_image=np.load("~/multimodel_rumor_detection/reason_feature/test_image_reason_feature.npy")
