...
def extract_bert_features(model_name='corpus/chinese_L-12_H-768_A-12', max_length=512):
    ...
    np.save("~/multimodel_rumor_detection/normal_feature/train_text_Bert_feature.npy", train_text_feature)
    test_text_feature = test_text_feature.detach().numpy()  # 使用detach()取消梯度
    np.save("~/multimodel_rumor_detection/normal_feature/test_text_Bert_feature.npy", test_text_feature)
