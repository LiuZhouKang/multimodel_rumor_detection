...
train_text_reason = np.load("~/multimodel_rumor_detection/reason_content/train_text_reason.npy", allow_pickle=True)
train_image_reason = np.load("~/multimodel_rumor_detection/reason_content/train_image_reason.npy", allow_pickle=True)
test_text_reason = np.load("~/multimodel_rumor_detection/reason_content/test_text_reason.npy", allow_pickle=True)
test_image_reason = np.load("~/multimodel_rumor_detection/reason_content/test_image_reason.npy", allow_pickle=True)
...
if __name__ == "__main__":
    ...
    np.save('~/multimodel_rumor_detection/reason_feature/test_image_reason_feature.npy', test_image_reason_feature.numpy())
