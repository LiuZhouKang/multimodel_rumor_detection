...
if __name__ == "__main__":
    ...
    X_train=torch.FloatTensor(np.load("~/multimodel_rumor_detection/main_datasets/train_mixed_feature.npy"))
    Y_train=torch.FloatTensor(np.load("~/multimodel_rumor_detection/main_datasets/train_label.npy"))
    X_test=torch.FloatTensor(np.load("~/multimodel_rumor_detection/main_datasets/test_mixed_feature.npy"))
    Y_test=torch.FloatTensor(np.load("~/multimodel_rumor_detection/main_datasets/test_label.npy"))
