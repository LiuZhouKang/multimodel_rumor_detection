...
if __name__ == "__main__":
    ...
    # 确保目录存在
    os.makedirs("~/multimodel_rumor_detection/clip_feature", exist_ok=True)
    # 保存特征
    np.save("~/multimodel_rumor_detection/clip_feature/train_text_clip_feature.npy", train_text_feature.numpy())
    np.save("~/multimodel_rumor_detection/clip_feature/test_text_clip_feature.npy", test_text_feature.numpy())
    np.save("~/multimodel_rumor_detection/clip_feature/train_image_clip_feature.npy", train_image_feature.numpy())
    np.save("~/multimodel_rumor_detection/clip_feature/test_image_clip_feature.npy", test_image_feature.numpy())
    np.save("~/multimodel_rumor_detection/clip_feature/train_label.npy", train_label)
    np.save("~/multimodel_rumor_detection/clip_feature/test_label.npy", test_label)